...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        User userx = userLoggedInService.getLoggedInUser();
        return testRequestQueryService.findByDoctor(userx);
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            User userx = userLoggedInService.getLoggedInUser();
            TestRequest result = testRequestUpdateService.assignForConsultation(id,userx);
            return result;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User userx = userLoggedInService.getLoggedInUser();
            TestRequest result = testRequestUpdateService.updateConsultation(id,testResult,userx);
            return result;
